...
namespace Tmf.InstaVerita.Core.ResponseModels;

public class InstaVeritaResponse
{
    [JsonPropertyName("blacklisted")]
    public dynamic? Blacklisted { get; set; }
    ...
    public dynamic? FitnessCertificateExpiryDate { get; set; }
...
public class BlackListDetails
{
    ...
    public dynamic? FirDate { get; set; }
    [JsonPropertyName("blacklisted_reason")]
    public string BlacklistedReason { get; set; } = string.Empty;
    [JsonPropertyName("blacklisted_date")]
    public dynamic? BlacklistedDate { get; set; }
